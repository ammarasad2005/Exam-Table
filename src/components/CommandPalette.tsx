...
export function CommandPalette() {
  ...
  const commands: Command[] = [
    // Navigate
    { id: 'nav-home', label: 'Home', hint: 'Config + dashboard', icon: Home, group: 'Navigate', action: () => router.push('/home'), keywords: 'config dashboard setup' },
    { id: 'nav-timetable', label: 'Timetable', hint: 'Weekly class schedule', icon: Clock, group: 'Navigate', action: () => router.push('/timetable'), keywords: 'classes weekly schedule' },
    { id: 'nav-timetable-custom', label: 'Custom Courses', hint: 'Build a custom timetable', icon: LayoutGrid, group: 'Navigate', action: () => router.push('/timetable/custom'), keywords: 'custom courses bundle' },
    { id: 'nav-optimizer', label: 'Timetable Optimizer', hint: 'Clash-free section combos', icon: Sparkles, group: 'Navigate', action: () => router.push('/timetable/optimizer'), keywords: 'optimizer clash sections' },
    { id: 'nav-schedule', label: 'Exam Schedule', hint: 'Exam finder', icon: SearchIcon, group: 'Navigate', action: () => router.push('/schedule'), keywords: 'exams schedule finder' },
    { id: 'nav-custom-exams', label: 'Custom Exams', hint: 'Build a custom exam list', icon: BookOpen, group: 'Navigate', action: () => router.push('/custom'), keywords: 'custom exams mock' },
    { id: 'nav-rooms', label: 'Free Rooms', hint: 'Find empty classrooms', icon: MapPin, group: 'Navigate', action: () => router.push('/rooms'), keywords: 'rooms empty free classroom' },
    { id: 'nav-semester', label: 'Semester Calendar', hint: 'Academic calendar', icon: CalendarDays, group: 'Navigate', action: () => router.push('/semester'), keywords: 'semester calendar holidays' },
    { id: 'nav-events', label: 'Campus Events', hint: 'Events calendar', icon: Calendar, group: 'Navigate', action: () => router.push('/events'), keywords: 'events campus' },
    { id: 'nav-faculty', label: 'Faculty Directory', hint: 'Browse faculty', icon: Users, group: 'Navigate', action: () => router.push('/faculty'), keywords: 'faculty directory teachers' },
    { id: 'nav-lost-found', label: 'Lost & Found', hint: 'Community board', icon: SearchIcon, group: 'Navigate', action: () => router.push('/lost-found'), keywords: 'lost found items' },
    { id: 'nav-landing', label: 'Landing', hint: 'Portal home', icon: Home, group: 'Navigate', action: () => router.push('/'), keywords: 'landing portal' },
    // Actions
    ...
    { id: 'act-admin', label: 'Admin Portal', hint: 'Login-gated', icon: Settings, group: 'Actions', action: () => router.push('/admin'), keywords: 'admin login' },
  ];
