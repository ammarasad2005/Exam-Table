    ...
    <>
      <main className="md:hidden min-h-dvh flex flex-col bg-[var(--color-bg)]">
        ...
        <div className="flex flex-col flex-1 px-4 pb-28 pt-4 gap-5">
          <p className="font-mono text-data-sm uppercase tracking-widest text-[var(--color-text-tertiary)] mb-2 events-panel-enter" style={{ animationDelay: '20ms' }}>
          ...
          <div className="grid grid-cols-3 gap-2 events-panel-enter" style={{ animationDelay: '160ms' }}>
            <div className="rounded-xl border p-2.5" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-bg-raised)' }}>
              <p className="font-mono text-data-sm text-[var(--color-text-tertiary)] uppercase tracking-widest">This Month</p>
              <p className="font-mono text-lg text-[var(--color-text-primary)] mt-1">{currentMonthEvents.length}</p>
            </div>
            <div className="rounded-xl border p-2.5" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-bg-raised)' }}>
              <p className="font-mono text-data-sm text-[var(--color-text-tertiary)] uppercase tracking-widest">Next Month</p>
              <p className="font-mono text-lg text-[var(--color-text-primary)] mt-1">{nextMonthEvents.length}</p>
            </div>
            <div className="rounded-xl border p-2.5" style={{ borderColor: 'var(--color-border)', backgroundColor: 'var(--color-bg-raised)' }}>
              <p className="font-mono text-data-sm text-[var(--color-text-tertiary)] uppercase tracking-widest">Tracked</p>
          ...
          {ongoingEvents.length > 0 && (
            ...
            >
              <h2 className="font-mono text-data-sm uppercase tracking-widest text-[var(--color-text-tertiary)] mb-3">
                Ongoing Snapshot
              </h2>
              <div className="flex flex-col gap-3">
                {ongoingEvents.map((event, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-start gap-2 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="mt-2 font-mono text-data-sm text-[var(--color-text-secondary)]">
                            {event.time}
                          </p>
                        </div>
                      </div>
                    ...
                    <p className="mt-1 font-mono text-data-sm text-[var(--color-text-tertiary)] flex items-start gap-1.5 pl-4">
            ...
            <div className="flex flex-col gap-3">
              {upcomingEvents.slice(0, 6).map((event, index) => (
                ...
                >
                  ...
                  <p className="mt-1 font-mono text-data-sm text-[var(--color-text-tertiary)] flex items-start gap-1.5">
                    <span aria-hidden="true">📍</span>
                    <span className="leading-relaxed">{event.event_location || 'Location not provided'}</span>
                  </p>
                </article>
